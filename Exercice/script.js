...
// // Date
// // getDate();
// // getMonth() 0(janv) 1(fev) .... 11(decembre)
// // getFullYear() 
...
// // Date en string jj/mm/aaaa =>  toLocaleDateString()


// // Temps en string hh:mm:ss =>   toLocaleTimeString()
...
// // span.innerHTML="La date : "+date.toLocaleDateString()+"<br>Temp: "+date.getHours()+"h"+date.getMinutes()+"m"+date.getSeconds()+"s";
...
try{
    ...
    console.log("Erreur detecté est : "+err.message);
}finally{
  console.log("Le reste du code")
}    
...
//     throw  new Error("Impossible a chrif")
// }finally{
...
//     console.log("Adulte");
// }else{
//     throw new Error("Vous etes mineur");
// }
